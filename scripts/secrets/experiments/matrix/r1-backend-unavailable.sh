...
echo "[wait began $(el)] store -> $(waitfor 400 'store' InvalidProviderConfig)"; echo "$(el) trellis-secrets -> $(waitfor 400 'es trellis trellis-secrets' SecretSyncedError) msg=$(esmsg trellis trellis-secrets)"
...
echo "[wait began $(el)] store -> $(waitfor 600 'store' Valid)"; echo "$(el) trellis-secrets -> $(waitfor 600 'es trellis trellis-secrets' SecretSynced)"
