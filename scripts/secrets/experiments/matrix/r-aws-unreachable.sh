...
# Restore on the LIVE object. The first run re-applied a saved copy and FAILED on a resourceVersion
# conflict (measured 2026-09-22), leaving the black hole in place; this path replaces the live object.
